...
abstract contract Rip7560BaseAccount is IRip7560Account {
    ...
    function validateTransaction(uint256 version, bytes32 txHash, bytes calldata transaction)
        external
        virtual
        override
    ...
    function _requireFromEntryPoint() internal view virtual {
        require(msg.sender == 0x0000000000000000000000000000000000007560, "account: not from EntryPoint");
    }
    ...
    function _decodeTransaction(bytes calldata transaction) internal pure returns (TransactionType4 memory txData) {
